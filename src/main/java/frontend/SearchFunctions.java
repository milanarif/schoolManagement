...
public class SearchFunctions {
    ...
    public static void searchCourse() {
        if (CourseFunctions.getAllCourses() != null && !CourseFunctions.getAllCourses().isEmpty()) {
    ...
    public static void searchStudent() {
        if (StudentFunctions.getAllStudents() != null && !StudentFunctions.getAllStudents().isEmpty()) {
    ...
    public static void searchTeacher() {
        if (TeacherFunctions.getAllTeachers() != null && !TeacherFunctions.getAllTeachers().isEmpty()) {
    ...
    public static void searchDepartment() {
        if (DepartmentFunctions.getAllDepartments() != null && !DepartmentFunctions.getAllDepartments().isEmpty()) {
